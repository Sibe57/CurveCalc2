...
class Calc8ViewController: UIViewController {
    ...
    */
    ...
    @IBAction func goCalc8(_ sender: Any) {
        ...
        let dXArray = [k2DXValue, k3DXValue, k4DXValue, k5DXValue, k6DXValue, k7DXValue, k8DXValue]
        
        let dYArray = [k2DYValue, k3DYValue, k4DYValue, k5DYValue, k6DYValue, k7DYValue, k8DYValue]
        ...
        hK8.text = "h K8 = " + String(Double(round(1000*hYValue)/1000))
